...
function EditUserForm({ onSubmit, isSubmitting, onClose, user }) {
  ...
  const availableRoles = ["ADMIN", "MANAGER", "RECEPTIONIST", "ACCOUNTANT"];
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-6 flex justify-end gap-3 border-t pt-6">
        ...
        >
          {isSubmitting ? <SpinnerMini /> : "Update User"}
        </Button>
      </div>
    </form>
  );
