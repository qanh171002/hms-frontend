...
function EditAssetForm({ onSubmit, isSubmitting, onClose, asset }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2 className="mb-6 text-xl font-semibold text-gray-800">Edit Asset</h2>
      ...
      <div className="mt-6 flex justify-end gap-3 border-t pt-6">
        ...
        <Button type="submit" disabled={isSubmitting}>
          {isSubmitting ? <SpinnerMini /> : "Update Asset"}
        </Button>
      </div>
    </form>
  );
